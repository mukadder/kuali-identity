...
public class VEFEntityType_names extends Vector< VEFEntityNameType> implements KvmSerializable
{
    ...
    public void loadFromSoap(java.lang.Object inObj,VEFExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                VEFEntityNameType j1= (VEFEntityNameType)__envelope.get(j,VEFEntityNameType.class,false);
                add(j1);
            }
        }
}
