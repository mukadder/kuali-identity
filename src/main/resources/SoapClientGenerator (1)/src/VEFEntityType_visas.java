...
public class VEFEntityType_visas extends Vector< VEFEntityVisaType> implements KvmSerializable
{
    ...
    public void loadFromSoap(java.lang.Object inObj,VEFExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                VEFEntityVisaType j1= (VEFEntityVisaType)__envelope.get(j,VEFEntityVisaType.class,false);
                add(j1);
            }
        }
}
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "visa";
        info.type = VEFEntityVisaType.class;
