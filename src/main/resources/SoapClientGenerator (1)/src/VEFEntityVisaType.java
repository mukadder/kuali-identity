...
public class VEFEntityVisaType extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,VEFExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("visaTypeKey"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return this.visaTypeKey!=null?this.visaTypeKey:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==3)
        {
            return this.visaEntry!=null?this.visaEntry:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==4)
        {
            return this.visaId!=null?this.visaId:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==5)
        {
