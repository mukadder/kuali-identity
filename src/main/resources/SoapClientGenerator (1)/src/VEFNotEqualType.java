...
public class VEFNotEqualType extends VEFabstractPredicate implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,VEFExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("booleanValue"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.booleanValue = new BigInteger(j.toString());
                    }
                }
                else if (obj instanceof BigInteger){
                    this.booleanValue = (BigInteger)obj;
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.booleanValue!=null?this.booleanValue.toString():SoapPrimitive.NullSkip;
        }
