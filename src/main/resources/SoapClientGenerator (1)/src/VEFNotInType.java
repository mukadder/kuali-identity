...
public class VEFNotInType extends VEFabstractPredicate implements KvmSerializable
{
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=count+0+this.stringValue.size()+this.dateTimeValue.size()+this.integerValue.size()+this.kualiDecimalValue.size()+this.kualiPercentValue.size() && propertyIndex < count+0+this.stringValue.size()+this.dateTimeValue.size()+this.integerValue.size()+this.kualiDecimalValue.size()+this.kualiPercentValue.size()+this.decimalValue.size())
        {
            java.lang.Object decimalValue = this.decimalValue.get(propertyIndex-(count+0+this.stringValue.size()+this.dateTimeValue.size()+this.integerValue.size()+this.kualiDecimalValue.size()+this.kualiPercentValue.size()));
    ...
    public int getPropertyCount() {
        return super.getPropertyCount()+0+stringValue.size()+dateTimeValue.size()+integerValue.size()+kualiDecimalValue.size()+kualiPercentValue.size()+decimalValue.size();
    }
