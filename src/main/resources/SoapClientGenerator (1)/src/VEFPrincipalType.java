...
public class VEFPrincipalType extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,VEFExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("principalId"))
        {
            if(obj!=null)
            {
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.principalId!=null?this.principalId:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==1)
        {
