...
public class VEFentityExternalIdentifierTypeType extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,VEFExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("encryptionRequired"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.encryptionRequired = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
                    this.encryptionRequired = (Boolean)obj;
                }
            }
            return true;
        }
